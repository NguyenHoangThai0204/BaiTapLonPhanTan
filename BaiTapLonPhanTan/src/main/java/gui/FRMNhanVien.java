...
//	private DAOPhatSinhMa daoPhatSinhMa;
    ...
    private void initComponents() throws RemoteException {
        ...
        jLabelCaLamViec.setText("Ca làm:");
        ...
        rdoTheoChucVuNV.setText("Chức Vụ");
...
//        ));
        ...
        btnThemNV.setIcon(new javax.swing.ImageIcon("D:\\PhatTrienUngDung\\baiTapLonCKPTUD\\baiTapLonCKPTUD\\iCon\\add.png")); // NOI18N
        btnThemNV.setText("Thêm");

        btnSuaNV.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        btnSuaNV.setIcon(new javax.swing.ImageIcon("D:\\PhatTrienUngDung\\baiTapLonCKPTUD\\baiTapLonCKPTUD\\iCon\\service.png")); // NOI18N
        btnSuaNV.setText("Sửa");

        btnLamMoi.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btnLamMoi.setIcon(new javax.swing.ImageIcon("D:\\PhatTrienUngDung\\baiTapLonCKPTUD\\baiTapLonCKPTUD\\iCon\\refresh.png")); // NOI18N
        btnLamMoi.setText("Làm Mới");


        btnXoaNV.setFont(new java.awt.Font("Segoe UI", 0, 13)); // NOI18N
        btnXoaNV.setIcon(new javax.swing.ImageIcon("D:\\PhatTrienUngDung\\baiTapLonCKPTUD\\baiTapLonCKPTUD\\iCon\\delete.png")); // NOI18N
        btnXoaNV.setText("Xóa");
        jbTimNV.setIcon(new javax.swing.ImageIcon("D:\\PhatTrienUngDung\\baiTapLonCKPTUD\\baiTapLonCKPTUD\\iCon\\search.png")); // NOI18N

        jbLocNV.setIcon(new javax.swing.ImageIcon("D:\\PhatTrienUngDung\\baiTapLonCKPTUD\\baiTapLonCKPTUD\\iCon\\sorting.png")); // NOI18N
...
*/
	...
	private void resetAll() {
		...
		jcboChucVu.setSelectedItem("Quản lý");
...
//
	 ...
	 * mã NV, tên NV, sđt, địa chỉ, cccd, ngaySinh, gioiTinh, chucVu
	 * @paramnv
	 */
	...
	private void loadDanhSachMaVaSdtNV(ArrayList<NhanVien> lstNV) throws RemoteException {
		// TODO Auto-generated method stub
		removeDanhSachNV(modelNV);
		ArrayList<NhanVien> lstMa = nhanVienDao.getMaVaSdtNVChoDDP(txtTim.getText().toLowerCase().trim());
...
//	}
	...
	/**
	 * Sắp xếp chức vụ tăng dần: nhân viên, quản lý
	 * @paramnv
	 */
//	private void sortChucVuTangDan()  {
//		removeDanhSachNV(modelNV);
//		ArrayList<NhanVien> lstNhanVien = nhanVienDao.sortCV("Nhân viên");
...
//		}
//
//		ArrayList<NhanVien> lstQL = nhanVienDao.sortCV("Quản lý");
...
//        String matKhau = phatSinhMaNV.concat(sdt);
        ...
        if(hoTen.equals("") || sdt.equals("") || diaChi.equals("") || cccd.equals("")) {
            ...
            if(regex.regexTen(txtHoTen) && regex.regexSDT(txtSDT) && regex.regexDiaChi(txtDiaChi) && regex.regexCCCD(txtCCCD)) {
                try {
                    if(nhanVienDao.checkSdtNV(txtSDT.getText())) {
                        if(nhanVienDao.checkCccdNV(cccd)) {
                            if(age>=18 && ngaySinh.getDate()>0 && ngaySinh.getDate()<=31 && ngaySinh.getMonth()>0 && ngaySinh.getMonth()<=12 && ngaySinh.getYear()>0 && ngaySinh.getYear()<nam) {
                                ...
                                tk1.setMatKhau(phatSinhMaNV);
                                new TaiKhoanImpl().createTaiKhoan(tk1 );
                                ...
                                if(jcboChucVu.getSelectedItem()=="Quản lý")
                                    nv.setLuong(10000000);
                                if(jcboChucVu.getSelectedItem()=="Nhân viên")
                                    nv.setLuong(5000000);
...
//                                String mkTK = "\nMật khẩu: "+matKhau;
                        ...
                        JOptionPane.showMessageDialog(this, "Số điện thoại đã đăng ký"+txtSDT.getText(), "Thông báo", JOptionPane.ERROR_MESSAGE);
                } catch (RemoteException e) {
                    throw new RuntimeException(e);
                }
            }
